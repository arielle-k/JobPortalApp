...
<html lang="en">
  <head>
    ...
    @include ('partials.head')
        ...
        <style>
             img{min-width:44px;width:44px;height:44px}
        </style>
  </head>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6 text-center" data-aos="fade">
            ...
            <p><a href="/register" class="btn btn-outline-success py-3 px-4">Job seeker</a> <a href="" class="btn btn-outline-warning py-3 px-4">Employer</a></p>
